...
function popjack()
 {
window.open('employeeInfo.html','popjack','toolbar=no,location=no,directories=no,status=no,menubar=no,resizable=yes,copyhistory=no,scrollbars=yes,width=480,height=320');
 }
//-->
</script>
